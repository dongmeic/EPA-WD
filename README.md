...
2) manual run to get correction notes
...
4. Mannually create the correction notes on Excel or on Jupter Notebook `notes_review_set4`, which will be saved as "unmatched_df_SetXXX_r2_N_notes.csv" (XXX as the set ID, same as below), can skip the partial taxlots in this step;
